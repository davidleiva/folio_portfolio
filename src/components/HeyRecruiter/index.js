    ...
    return (
        ...
        >
            ...
            <>
                ...
                ></button>
                <h3><span role="img" aria-label="Hey recruiter!">🙋🏽‍♂️</span> Hey recruiter!</h3>
                <ul className="mb-0">
                    <li style={{
                        ...
                        >
                            <i className="align-middle icon icon-logo-linkedin mr-1"></i>
                            <span>Linkedin profile</span></a></li>
                    <li style={{
                        display: 'inline-block'
                    }}>
                        <button
                    ...
                    <li style={{
                        ...
                        <a
                            ...
                            style={{lineHeight: '16px'}}
                        >
                            <i className="align-middle icon icon-phone-call mr-1"></i>
                            <span className="d-none d-md-inline">+34653071080</span>
                        </a>
                    </li>
                    <li style={{
                        display: 'inline-block'
                        ...
                        <a
                            ...
                            style={{lineHeight: '16px'}}
                        >
                            <i className="align-middle icon icon-email-84 mr-1 d-none d-inline-md"></i>
                            {/* <span className="d-none d-inline-md">hello@imdavidleiva.com</span> */}
                            <span className="d-none d-md-inline">davidleivaherrero@gmail.com</span>
            ...
            >
                <i className="icon icon-minimal-right" style={{ opacity: 0.5}}></i>
            </button>
            }
            </div>
    );
