    ...
    <>
      <PageWrapper>
            ...
            <Row className="justify-content-center text-center mb-5">
              <Col lg="8">
                <Box>
                  ...
                  >Creating your own website is not always easy.
                  </Title>
                  <Text
                    variant="p"
                    css={` 
                      max-width: 750px;
                    `}
                  >In a company of almost 500 people that are busy as hell, is not always easy to renew your site. We did finally.</Text>
                </Box>
              </Col>
            </Row>
        ...
        <Container>
          ...
          <Row>
            <Col lg="6">
              <img src={imgS1} alt="netcentric" className="mb-3 img-fluid w-100 shadow" />
            </Col>
            <Col lg="6">
              <img src={imgS2} alt="netcentric" className="mb-3 img-fluid w-100 shadow" />
            </Col>
            <Col lg="6">
              <img src={imgS3} alt="netcentric" className="mb-3 img-fluid w-100 shadow" />
            </Col>
            <Col lg="6">
              <img src={imgS4} alt="netcentric" className="mb-3 img-fluid w-100 shadow" />
            </Col>
          </Row>
        </Container>
