        ...
        <Section hero>
          <Container>
            <Row className="justify-content-center text-center mb-5">
              <Col lg="8">
                <Box>
                  <Text variant="tag">PRODUCT · UX · UI · FRONT-END</Text>
                  <Title
                    className="my-4"
                    style={{ fontSize: '2.5rem', lineHeight: '3rem', }}
                  >Timedi created Ti-Dose: a "Personalized Dose System" software.</Title>
                  <Text
                    variant="p"
                    css={`
                      max-width: 750px;
                    `}
                  >Pharma's Personalized Dose System for hospitals and elderly residences still needs good UX.</Text>
                </Box>
              </Col>
            </Row>
            ...
            <Row>
                <Col>
                    <Box>
                        ...
                        <Text variant="p" className="mb-4">Helping people who need chronic medication is always a good goal if that's what you do for a living.</Text>
                        <Text variant="p" className="mb-4">Ti-Medi is a medium size company that had software developed and needed to improve the user experience of their whole platform.</Text>
                        <Text variant="p" className="mb-4">Once I joined the team, I created a design system, this was replicated on storybook, I specified new features using problem solving techniques, I made research, I installed hotjar, I made designs for the new features, and also coded some of them.
                         </Text>
                    </Box>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg="3">
                    ...
                    <List>
                        <li className="mb-2">Quantitative: Hotjar sessions & heat maps</li>
