                            ...
                            <Col lg="8">
                                <Box>
                                    ...
                                    <Title className="my-4">
                                        Complete Branding <br /> Solution for
                                        DataTryper.
                                    </Title>
                                    <Text
                                        variant="p"
                                        ...
                                        `}
                                    >
                                        To satisfy our goal of creating a brand
                                        that could adapt across many use cases,
                                        we took the base form of their new logo
                                        and used it as an artboard. As long as
                                        the structural outline of the mark
                                        stayed consistent their brand was
                                        allowed to.
                                    </Text>
                                </Box>
                            </Col>
