            ...
            <Row className="justify-content-center text-center mb-5">
              <Col lg="8">
                <Box>
                  ...
                  >Cliventa tried to be the revolution on the Spanish real-estate market.
                  </Title>
                  <Text
                    variant="p"
                    css={` 
                      max-width: 750px;
                    `}
                  >The key factor on Cliventa's strategy was to connect directly sellers and buyers, removing intermediaries. Unfortunately, we weren't the only ones on that path.</Text>
                </Box>
              </Col>
            </Row>
                ...
                <Col>
                    <Box>
                        ...
                        <Text variant="p" className="mb-4">
                            Cliventa's CEO contacted me because he considered my profile could fit perfectly. He just finished a master's degree and had this idea of removing intermerdiaries in the process of buying a real estate property.
                        </Text>
                        <Text variant="p" className="mb-4">
