...
import imgS1 from "../assets/image/png/elegir-1.png";
import imgS2 from "../assets/image/png/elegir-2.png";
import imgS3 from "../assets/image/png/elegir-3.png";
import imgS4 from "../assets/image/png/elegir-4.png";
      ...
      <PageWrapper>
          ...
          <Container>
            <Row className="justify-content-center text-center mb-5">
              <Col lg="8">
                <Box>
                  ...
                  >
                    A social & personal project <br /> that started while
                  ...
                  <Text
                    ...
                    `}
                  >
                    I attended a bootcamp to acquire more skills regarding
                    product design. This project was my final deliverable. It
                    aims to change politics, and it aims to be the neighborhood
                    association of the 21st century.
                  </Text>
                </Box>
              </Col>
            </Row>
              ...
              <Col>
                <Box>
                  ...
                  <Text variant="p" className="mb-4">
                    While I was attending a bootcamp to acquire more skills in
                    the field of product design, I was already collaborating
                    with a neighborhood association to improve the management of
                    the town hall and the institutions in my town.
                  </Text>
                  <Text variant="p" className="mb-4">
                    Therefore, I took advantage of these circumstances to create
                    the final deliverable project: The brand of the project
                    become the one for the association, changing a little bit to
                    fit their needs ("Escollir" is Catalan instead of Spanish
                    "Elegir"), and currently I'm designing the site, app, the
                    communication strategy and creating tools to work internally
                    and externally.
                  </Text>
                  <Text variant="p" className="mb-4">
                    <b>
                      Please bear in mind the project is still under
                      development.
                    </b>
                  </Text>
                </Box>
            ...
            <Row>
              ...
              <Col lg="3">
                ...
                <List>
                  <li className="mb-2">
                    Quantitative: Bot survey made with Landbot
                  </li>
              ...
              <Col lg="3">
                ...
                <List>
                  ...
                  <li className="mb-2">
                    Main metrics definiton (North Star, User Activity,
                    Retention, Referral, Engagement)
                  </li>
        ...
        <Container>
          ...
          <Row>
            ...
            <Col lg="6">
              <img src={imgS3} alt="" className="mb-3 img-fluid w-100 shadow" />
            </Col>
            <Col lg="6">
              <img src={imgS4} alt="" className="mb-3 img-fluid w-100 shadow" />
            </Col>
          </Row>
        </Container>
          ...
          <Container>
            <Row>
              ...
              <Col lg="12" className="d-flex flex-column align-items-center">
                ...
                <div>
                  <a
                    href="https://drive.google.com/file/d/1fOETQbiV7VYdVs7i8c6K0eVRKHt5YADF/view?usp=sharing"
                    target="_blank"
                  >
                    <Button
                      arrowRight
