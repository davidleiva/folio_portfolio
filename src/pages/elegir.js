                ...
                <Section hero>
                    <Container>
                        <Row className="justify-content-center text-center mb-5">
                            <Col lg="8">
                                <Box>
                                    ...
                                    >
                                        A social & personal project <br /> that
                                        started while attending a Bootcamp.
                                    </Title>
                                    <Text
                                        variant="p"
                                        css={`
                                        ...
                                        `}
                                    >
                                        I attended a bootcamp to acquire more
                                        skills regarding product design. This
                                        project was my final deliverable. It
                                        aims to change politics, and it aims to
                                        be the neighborhood association of the
                                        21st century.
                                    </Text>
                                </Box>
                            </Col>
                            ...
                            <Col>
                                <Box>
                                    ...
                                    <Text variant="p" className="mb-4">
                                        While I was attending a bootcamp to
                                        acquire more skills in the field of
                                        product design, I was already
                                        collaborating with a neighborhood
                                        association to improve the management of
                                        the town hall and the institutions in my
                                        town.
                                    </Text>
                                    <Text variant="p" className="mb-4">
                                        Therefore, I took advantage of these
                                        circumstances to create the final
                                        deliverable project: The brand of the
                                        project become the one for the
                                        association, changing a little bit to
                                        fit their needs ("Escollir" is Catalan
                                        instead of Spanish "Elegir"), and
                                        currently I'm designing the site, app,
                                        the communication strategy and creating
                                        tools to work internally and externally.
                                    </Text>
                                    <Text variant="p" className="mb-4">
                                        <b>
                                            Please bear in mind the project is
                        ...
                        <Row>
                            <Col lg="3">
                                <h6 className="mb-2">
                                    Problem solving & Strategy tools:
                                </h6>
                                <List>
                                    <li className="mb-2">
                            ...
                            <Col lg="3">
                                ...
                                <List>
                                    <li className="mb-2">
                                        Quantitative: Bot survey made with
                                        Landbot
                                    </li>
                                    <li className="mb-2">
                            ...
                            <Col lg="3">
                                ...
                                <List>
                                    ...
                                    <li className="mb-2">
                                        Minimal App prototype in Figma
                                    </li>
                                </List>
                            </Col>
                            <Col lg="3">
                                ...
                                <List>
                                    ...
                                    <li className="mb-2">
                                        Ionic / Capacitator / React /{' '}
                                    </li>
                                    <li className="mb-2">
                                        Contenful (no code backend)
                                    </li>
                                </List>
                            </Col>
                        </Row>
